...
class SinaisRecebidos(models.Model):
    ...
    idsinais_recebidos = models.AutoField(primary_key=True,verbose_name="ID do Emissor")
    nome_sinal = models.CharField(max_length=200, blank=True, null=True,verbose_name="Nome do Emissor",help_text="Insira o nome completo do usuário.")
...
class ClientesSinais(models.Model):
    ...
    multiplicador = models.DecimalField(max_digits=9, decimal_places=3, blank=True, null=True, help_text="Valor inteiro pelo qual o sinal emissor será multiplicado neste receptor. Ex: (1,5 ou 10)")
    numero_conta = models.CharField(max_length=30, blank=True, null=True,verbose_name="Número da Conta",help_text="Número da conta receptora deste sinal.")
    senha_conta = models.CharField(max_length=30, blank=True, null=True,verbose_name="Senha da Conta Metatrader",help_text="Senha da conta receptora do sinal. Só preencher este campo se o receptor for Metatrader/EA6.")
    nome_ea = models.CharField(choices=EA, max_length=50, blank=True, null=True,verbose_name="Software Receptor")
    magic_number = models.PositiveIntegerField(blank=True, null=True,verbose_name="Magic Number",help_text="Identificador do Robô. Só preencher este campo se o receptor for Metatrader/EA6.")
    data_cadastro = models.DateTimeField(blank=True, null=True)
    ativo = models.IntegerField()
    idsinais_recebidos = models.PositiveIntegerField(verbose_name="ID do Emissor")
    tipo_sinal = models.IntegerField()
    utilizar_mesmo_ativo_sinal = models.IntegerField(choices=SIM_NAO,blank=True, null=True,verbose_name="Mesmo Ativo do Emissor",help_text="Só preencher este campo se o receptor for Metatrader/EA6.")
    sigla_ativo_cliente = models.CharField(max_length=45, blank=True, null=True,verbose_name="Código do Ativo no Receptor",help_text="Caso a resposta anterior seja NÃO preencha o código. Só preencher este campo se o receptor for Metatrader/EA6.")
    corretora = models.CharField(max_length=45, blank=True, null=True,help_text="Corretora na qual o Metatrader foi contratado. Só preencher este campo se o receptor for Metatrader/EA6")
...
class MetatraderHistorico(models.Model):
    ...
    def __str__(self):
        return self.numero_conta  # Substitua pelo campo desejado
